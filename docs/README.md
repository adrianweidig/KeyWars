...
- [Backup und Restore](backup-restore.md): konsistente SQLite-Sicherungen
...
- [Feature-Matrix](features.md): verfügbarer Umfang und offene Abnahmen
...
- [ADR 0001](adr/0001-one-container-sqlite.md): ein Container mit SQLite
...
- [ADR 0009](adr/0009-inmemory-room-state.md): flüchtiger Raumzustand
- [ADR 0010](adr/0010-bounded-channels.md): begrenzte Progress-Deltas
- [ADR 0011](adr/0011-vertical-scaling.md): vertikale Skalierung
