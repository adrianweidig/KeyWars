...
Mehrere Domain Controller werden mit Semikolon getrennt. `ldap://` ist nur erlaubt, wenn `KEYWARS__LDAP__ALLOW_STARTTLS=true` gesetzt ist. Es gibt kein Servicekonto und keine Gruppenzulassung.
